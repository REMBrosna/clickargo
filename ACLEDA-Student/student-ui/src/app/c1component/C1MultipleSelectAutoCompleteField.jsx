 ...
 * @param helperText - text to display if error occurs
  */
const C1MultipleSelectAutoCompleteField = ({
    label,
    name,
    onChange,
    value,
        ...
        renderOption={(option, { selected }) => (
            <React.Fragment>
                <Checkbox
                    ...
                    checked={selected}
                />
                {isShowCode ? `${option.value} - ${option.desc}` : option.desc}
            </React.Fragment>
        )}
        loading={isLoading}
        value={value}
...
C1MultipleSelectAutoCompleteField.propTypes = {
...
export default C1MultipleSelectAutoCompleteField;