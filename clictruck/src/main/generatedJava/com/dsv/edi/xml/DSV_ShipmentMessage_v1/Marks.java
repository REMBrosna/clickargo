 ...
 *       &lt;sequence>
 *         &lt;element name="ShippingMark" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Marks {
    ...
    @XmlElement(name = "ShippingMark", required = true)
    protected List<String> shippingMark;
     ...
     * 
     */
    public List<String> getShippingMark() {
        if (shippingMark == null) {
            shippingMark = new ArrayList<String>();
        }
