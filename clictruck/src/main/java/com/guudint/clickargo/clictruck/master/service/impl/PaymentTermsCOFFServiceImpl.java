...
public class PaymentTermsCOFFServiceImpl extends AbstractPaymentTermsService {

	private static final Logger LOG = Logger.getLogger(PaymentTermsCOFFServiceImpl.class.getName());
	...
	public List<PaymentTerms> listAll() {
		...
		try {
			...
			String strList = getSysParam(KEY_PAYMENT_TERMS_COFF);
