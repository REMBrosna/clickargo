...
public class CkCtAccnInqReqDocsServiceImpl2
		extends AbstractClickCargoEntityService<TCkCtAccnInqReqDocs, String, CkCtAccnInqReqDocs> {

	private static Logger log = Logger.getLogger(CkCtAccnInqReqDocsServiceImpl2.class);
	...
	public CkCtAccnInqReqDocsServiceImpl2() {
