...
/**
 * VSagePayOut generated by hbm2java
 */
@Entity
@Table(name = "V_CK_SAGE_PAY_OUT")
@JsonIgnoreProperties(value = { "hibernateLazyInitializer", "handler", "fieldHandler" })
public class VCkSagePayOut extends COAbstractEntity<VCkSagePayOut> {
	...
	///////////////////
	@Override
	public int compareTo(VCkSagePayOut arg0) {
		return 0;
	}
	...
	@Column(name = "SAGE_TYPE", nullable = false, length = 11)
