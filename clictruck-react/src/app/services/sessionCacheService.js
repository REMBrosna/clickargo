...
const SessionCache = (function () {
  ...
  let getShellCardsList = function () {
    return shellCardsList;
  };

  let setShellCardsList = function (ShellCardsListParam) {
    shellCardsList = ShellCardsListParam;
  };

  let getTrucksList = function () {
    return trucksList;
  };

  let setTrucksList = function (trucksListParam) {
    accnList = trucksListParam;
  };

  let getAccnList = function () {
    return accnList;
  };

  let setAccnList = function (accnListParam) {
    accnList = accnListParam;
  };
...
*/
  return {
    getShellCardsList: getShellCardsList,
    setShellCardsList: setShellCardsList,
    getTrucksList: getTrucksList,
    setTrucksList: setTrucksList,
    getAccnList: getAccnList,
    setAccnList: setAccnList,
