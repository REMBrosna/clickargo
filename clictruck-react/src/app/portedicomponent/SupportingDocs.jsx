...
const SupportingDocs = ({
    ...
    let isDisabled = isEnabled ? isEnabled : isEditable(viewType);
    ...
    // const [isRequired, setIsRequired] = useState(isExpDtRequired);
    const handleAutoCompleteInput = (e, name, value) => {
        // PORTEDI-1633 - Ship Particular not required on VP
        // if (appType === 'VP' && name === 'docType'
        //     && (e.target.innerText === 'Ship Particular' || value?.value === 'D80')) {
        //     setIsRequired(false);
        // } else {
        //     setIsRequired(isExpDtRequired);
        // }
    ...
    const onLocalFileChangeHandler = (e) => {
        ...
        fileReader.onload = e => {
            ...
            //let base64Sign = btoa(imgStr); //btoa() is deprecated.
    ...
    const handleBtnAddFile = (e) => {
        // console.log("handleBtnAddFile", e);
    ...
    useEffect(() => {
        ...
        // sendRequest(`/api/portedi/suppAsocDocs/${appType}/${appId}`, 'getDocs', 'get');
                ...
                <Grid container alignItems="flex-start" spacing={3} className={fieldClass.gridContainer}>
                    ...
                    <Grid item xs={4}>
                        ...
                        {/* <C1InputField
                            ...
                            helperText={(errors && errors.data)} />

                        {isRequireExpireDate && <C1DateField
                            label="Expire Date"
                            name="expireDate"
                            disabled={isDisabled}
                            type="date"
                            ...
                            onChange={handleDateChange}
                            value={uploadFile.extAttr.expireDate}
                            error={(errors && errors.expireDate)}
                            helperText={(errors && errors.expireDate)}
                        />} */}
                    </Grid>
                                            ...
                                            (<TableRow key={sr.id}>
                                                ...
                                                <TableCell align="center">
                                                    ...
                                                    {!isDisabled && <IconButton aria-label="Delete" type="button"
                                                        color="primary" onClick={(e) => handleDeleteFile(e, sr.id)}>
                                                        <DeleteIcon />
                                                    </IconButton>}
            ...
            <Dialog
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description" color="inherit">
                        File cannot be retrieved from server. Please try again and contact PortEDI support if problem persist.
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
