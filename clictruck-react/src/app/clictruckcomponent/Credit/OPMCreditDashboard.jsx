...
const OPMCreditDashboard = (props) => {
  const {
    data,
    origin,
    historyRoute,
            ...
            <Grid container justifyContent="flex-end">
              ...
              <Grid item>
                <C1LabeledIconButton
                  ...
                  action={() =>
                    history.push(historyRoute, { ...data, isOpm: true })
                  }
                >
        ...
        >
          <Grid item md={3} xs={12}>
            <CreditItem
              ...
              amount={isCap ? data?.crTxnCap : data?.opmSummary?.opmsAmt}
            />
          </Grid>
          <Grid item md={3} xs={12}>
            <CreditItem
              color={orange[300]}
              category="Reserve"
              amount={data?.opmSummary?.opmsReserve}
            />
          </Grid>
          <Grid item md={3} xs={12}>
            <CreditItem
              ...
              category="Utilized"
              amount={data?.opmSummary?.opmsUtilized}
            />
          </Grid>
          <Grid item md={3} xs={12}>
            <CreditItem
              ...
              category="Balance"
              amount={data?.opmSummary?.opmsBalance}
            />
          </Grid>
        </Grid>
      </Box>
...
export default OPMCreditDashboard;
