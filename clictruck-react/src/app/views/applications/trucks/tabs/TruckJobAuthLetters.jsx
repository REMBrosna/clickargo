        ...
        },
        {
            ...
            options: {
                ...
                customBodyRender: (value, tableMeta, updateValue) => {
                    ...
                    let attType = tableMeta.rowData[5];
                    return <C1DataTableActions
                    // downloadFileEventHandler={(e) => handleViewFile(e, attId)}
                    // />
                    >
                        <Grid container alignItems="flex-start" justifyContent="flex-center">
                            ...
                            <span style={{ minWidth: '48px' }}>
                                {((inputData?.tckJob?.tckMstJobState?.jbstId === JobStates.DRF.code
                                    ...
                                    && viewType !== "view" && attType !== "BL") &&
                                    <Tooltip title={t("buttons:delete")} >
                                        <IconButton onClick={(e) => handleDeleteConfirm(e, attId)}>
...
export default TruckJobAuthLetters;