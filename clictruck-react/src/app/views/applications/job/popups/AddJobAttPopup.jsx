            ...
            <Grid container item xs={12} sm={6} direction="column">
                <C1SelectField
                    ...
                    optionsMenuItemArr={Object.values(attTypeList).map((item) => {
                        // Only show OTHERS at this time
                        if (item.mattId === "OTH") {
                            return <MenuItem value={item.mattId} key={item.mattId}>{item.mattName}</MenuItem>
                        }
                    })}
                    error={!!errors.mattId}
                ...
                <C1InputField
                    ...
                    name="attRefNo"
                    value={inputData?.attRefNo ? inputData?.attRefNo : ""}
                    onChange={handleInputChange}
                    required
                    error={errors && errors.attRefNo ? true : false}
                    helperText={errors && errors.attRefNo ? errors.attRefNo : null}
                />
            </Grid>
