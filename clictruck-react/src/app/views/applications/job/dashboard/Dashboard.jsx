...
const Dashboard = ({ docs }) => {
    ...
    const { user } = useAuth();
    let isCoFfHasFinanceRole = user?.authorities?.some(el => Roles.FF_FINANCE.code) && (user?.coreAccn?.TMstAccnType?.atypId === AccountTypes.ACC_TYPE_CO.code
    ...
    return (
        <div className="m-sm-30">
            {isCoFfHasFinanceRole && <DashboardCredit />}
