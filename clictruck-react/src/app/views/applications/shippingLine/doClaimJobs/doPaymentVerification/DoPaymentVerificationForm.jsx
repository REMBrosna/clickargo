...
import { getActionButton, isEditable, previewPDF, Uint8ArrayToString } from "app/c1utils/utility";
...
import DoJobPayments from "./DoJobPayments";

const DoPaymentVerificationForm = () => {
    ...
    useEffect(() => {
        if (viewType === 'new') {
            ...
            setLoading(true);
            // sendRequest("/api/jobs/details/" + jobId, "getJob", "get", null);
    ...
    let bcLabel = "ClicDo DO Claim Job - Payment Verification"
    let formButtons;
    if (!loading) {
        formButtons = (
            <C1FormButtons
                ...
                <Grid container spacing={3}>
                    <Grid item xs={12}>
                        <Paper>
                            ...
                            {tabIndex === 1 && <DoJobPayments viewType={viewType}
                                handleInputChange={handleInputChange}
                                handleDateChange={handleDateChange}
                                handleInputFileChange={onFileChangeHandler}
                                handleViewFile={handleViewFile}
...
export default withErrorHandler(DoPaymentVerificationForm);