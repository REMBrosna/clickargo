...
import TaxSequence from "./grid/TaxSequence";
import TaxReports from "./grid/TaxReports";
import TaxInvoices from "./grid/TaxInvoices";
...
const DashboardPanel = () => {
    ...
    useEffect(() => {
        sendRequest(`/api/v1/clickargo/clictruck/dashboard/taxmodules`);
