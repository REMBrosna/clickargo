...
import ActiveAccount from "./grid/ActiveAccount";
import SuspendAccount from "./grid/SuspendAccount";
...
const DashboardPanel = () => {
    ...
    const workBenchSelectedId = "dashboardTax";

    useEffect(() => {
        // sendRequest(`/api/v1/clickargo/opadmin/dashboard`);
        if (refreshPage !== 0) {
            setRefreshPage(0);
            console.log("refresh page");
        }
        sendRequest(`/api/v1/clickargo/clictruck/dashboard/accnSuspend`);
    ...
    const prepareListComponent = (data) => {
        ...
        console.log("carousel component", carouselItemsComponent);
