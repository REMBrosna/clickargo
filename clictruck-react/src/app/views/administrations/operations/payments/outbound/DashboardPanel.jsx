...
const DashboardPanel = () => {
    ...
    useEffect(() => {
        ...
        sendRequest(`/api/v1/clickargo/clictruck/dashboard/outboundPayment`);
    ...
    useEffect(() => {
        ...
        //     // sendRequest("/api/v1/clickargo/clictruck/dashboard/outboundPayment/fake");
        //     const dashboard = {"data":[{"id":0,"dbType":"APPROVED_JOBS","title":"Approved Jobs","transStatistic":{"APPROVED":"-"},"accnType":"SP_OP_ADMIN","image":null},{"id":1,"dbType":"JOB_PAYMENTS","title":"Job Payments","transStatistic":{"ACTIVE":"-","PAID":"-"},"accnType":"ACC_TYPE_SP","image":null}]};
        //     setLoading(isLoading);
        //     setCardItems(dashboard.data)
        //     prepareListComponent(dashboard.data);
        // }
