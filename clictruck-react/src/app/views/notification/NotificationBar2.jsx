      ...
      >
        <div className={classes.notification}>
          <div className="notification__topbar elevation-z6 flex items-center p-4">
            ...
            <h5 className="ml-2 my-0 font-medium">{t("configuration:notificationPreferences.messages.notifications")}</h5>
          </div>
          ...
          {!!notifcationList.length && (
            <div className="text-center m-8">
              <Button className="w-full" variant="contained" color="primary">
                {t("configuration:notificationPreferences.messages.viewAllNotif")}
              </Button>
            </div>
          )}
        </div>
