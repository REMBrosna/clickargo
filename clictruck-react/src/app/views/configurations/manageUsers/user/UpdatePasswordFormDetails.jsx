...
const UpdatePasswordFormDetails = () => {
        ...
        try {
            ...
            if(Object.keys(validation).length === 0) {
                ...
                const res = await axios.put(
                    "/api/v1/clickargo/clictruck/manageusr/chgpwd",
                    inputData
                );
                if (res.data) {
    ...
    const handleValidate = () => {
        ...
        for (const key in { newPassword, confirmPassword, currentPassword }) {
            if (inputData[key] === "") {
    ...
    const formButtons = <C1FormButtons options={{ submit: { eventHandler: handleSubmit}}} />;
