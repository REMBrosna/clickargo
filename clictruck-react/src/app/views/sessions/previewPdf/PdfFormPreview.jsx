...
export default function PdfFormPreview() {
    ...
    useEffect(() => {
        sendRequest("/api/app/preview/" + appType + "/" + appId, "previewPdf", "GET");
        ...
        <React.Fragment>
            <div className={classes.root}>
                ...
                <div className={classes.pdfContent}>
                    ...
                    {isLoading ? <MatxLoading /> : <iframe title='PDF Preview' className={classes.iframe} src={data ? `data:application/pdf;base64,${data}` : null} frameBorder="0" />}
                </div>
