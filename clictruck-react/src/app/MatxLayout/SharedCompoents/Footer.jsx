...
import Announcement from "app/views/sessions/notification/Announcement";
            ...
            >
              ...
              <Button variant="contained" color="secondary">
                Get MatX Pro
                    ...
                    <Announcement onOpen={{ open: openAnncmt }} onClose={handleAnnouncementClose} data={anncmtData} />

                    <span className="m-auto"></span>
                    {/* <p className="m-0">
            Developed and Powered by Japanese Grant Aid
          </p> */}
                </div>
            </Toolbar>
        </AppBar >
