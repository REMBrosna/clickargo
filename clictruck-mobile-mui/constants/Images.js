const ClictruckLogo = require("../assets/images/Clic-Logo_Colour-300x187.png");
const TruckDriver = require("../assets/images/truck_driver.png");
...
const ActiveBtnIcons = {
    cargo: require("../assets/images/button/cargo.png"),
    remark: require("../assets/images/button/remarks.png"),
    pickup: require("../assets/images/button/pickup.png"),
    deliver: require("../assets/images/button/deliver.png"),
    dropOff: require("../assets/images/button/dropoff.png")
